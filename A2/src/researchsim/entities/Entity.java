...
public abstract class Entity implements Encodable {
    ...
    /**
     * Return the machine-readable string representation of this entity
    ...
    @Override
    public int hashCode() {
        return Objects.hash(size.moveDistance, size.points, coordinate);
    }

    /**
     * Return true if and only if this entity is equal to the other given object
    ...
    public boolean equals(Object other) {
        return other instanceof Entity
                && ((Entity) other).size == this.size
                && ((Entity) other).coordinate.equals(this.coordinate);
    }
