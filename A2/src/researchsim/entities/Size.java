...
public enum Size {
    ...
    /**
     * How many points (score) earned for collecting an entity
     */
    public final int points;

    /**
     * How far an entity can move on the scenario map
     */
    public final int moveDistance;

    /**
     * Creates a size associate to an entity.
     * @param points the points (score) earned for collecting
     * @param moveDistance how far it can move on the scenario map
     */
